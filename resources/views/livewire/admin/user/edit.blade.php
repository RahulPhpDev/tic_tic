            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlInput3" name wire:model="gender">
                    ...
                    <button wire:click.prevent="update({{$this->editId}})" class="btn btn-success">Save</button>
